...
?>
  <input class="regular-text" name="up_options[og_title]" value="<?php echo esc_attr($options['og_title']); ?>" />
<?php
}

function up_options_section_cb()
{
?><p>An alternative form for updating options with the settings API.</p>
<?php
...
function og_image_input_cb()
{
  $options = get_option('up_options');
?>
  <input type="hidden" name="up_options[og_img]" id="up_og_image" value="<?php echo esc_attr($options['og_img']); ?>">
...
function og_description_input_cb()
{
  $options = get_option('up_options');
?>
  <textarea name="up_options[og_description]" class="large-text"><?php echo esc_html($options['og_description']); ?></textarea>
<?php
}
...
?>
  <label for="up_enable_og">
    <input name="up_options[enable_og]" type="checkbox" id="up_enable_og" value="1" <?php checked('1', $options['enable_og']); ?> />
    <span>Enable</span>
  </label>
<?php
}
