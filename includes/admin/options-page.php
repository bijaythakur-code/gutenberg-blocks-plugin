      ...
      <table class="form-table">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input name="up_og_title" type="text" id="up_og_title" class="regular-text" value="<?php echo esc_attr($options['og_title']); ?>" />
            </td>
          </tr>
          <!-- Open Graph Image -->
          <tr>
            ...
            <td>
              <input type="hidden" name="up_og_image" id="up_og_image" value="<?php echo esc_attr($options['og_img']); ?>" />
          ...
          <tr>
            ...
            <td>
              <textarea id="up_og_description" name="up_og_description" class="large-text">
              <?php echo esc_attr($options['og_description']); ?>
              </textarea>
            </td>
          </tr>
          <!-- Enable Open Graph -->
